...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2020 at 02:32 AM
...
CREATE TABLE `tbl_siswa` (
  ...
  `jenis_kelanin` varchar(255) CHARACTER SET latin1 NOT NULL,
  `tgl_masuk` date NOT NULL,
  `jurusan` varchar(255) CHARACTER SET latin1 NOT NULL,
  `bioadata` text CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `tbl_siswa` (`id`, `nama_siswa`, `alamat`, `jenis_kelanin`, `tgl_masuk`, `jurusan`, `bioadata`, `avatar`) VALUES
